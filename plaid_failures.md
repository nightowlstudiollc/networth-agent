...
Common institutions that fail to connect via Plaid Link.
...
| Not supported | Synchrony / CareCredit | Not supported | Not available in Plaid |
| BNPL | Affirm | Not supported | BNPL not available in Plaid |
| BNPL | Klarna | Not supported | BNPL not available in Plaid |
| Wrong product | Coinbase | Wrong product | Plaid connects to Base Wallet, not main Coinbase |
