...
def _resolve_token() -> dict:
    """Return a valid token dict, refreshing or fetching new as needed."""
...
def get_valid_token() -> str:
    """Get a valid access token, refreshing or fetching new if needed."""
    return _resolve_token()["access_token"]


def get_token_with_expiry() -> tuple:
